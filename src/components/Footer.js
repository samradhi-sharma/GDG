      ...
      <div className="footer-container">
        ...
        <div className="footer-social">
          ...
          <a href="#twitter" className="social-link">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.008 10.008 0 01-3.127 1.196 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.99 4.99 0 01-2.212.085 4.93 4.93 0 004.604 3.417 9.863 9.863 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.95 13.95 0 007.557 2.209c9.053 0 14-7.5 14-14 0-.21 0-.42-.015-.63A10.012 10.012 0 0024 4.59z" />
            </svg>
          </a>
